...
| **pai:story** | "出原型" / "/pai:story" | 5-step requirements analysis: prototype ASCII wireframes → data flows → backend flows → API list → feature points. Outputs 5 `ai/*.md` files. Connects PRD to design. |
